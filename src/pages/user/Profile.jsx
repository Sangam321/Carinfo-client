...
const Profile = () => {
  ...
  // Retrieve the favorite cars from localStorage
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 my-10">
      ...
      <div>
        <h1 className="font-medium text-lg">Cars you added as favourite</h1>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 my-5">
          {favoriteCars.length === 0 ? (
            <h1>You haven't added any favorite cars yet</h1>
          ) : (
